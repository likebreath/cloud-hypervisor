...
impl IvshmemDevice {
    ...
    pub fn assign_region(&mut self, region: Arc<GuestRegionMmap>, mapping: UserspaceMapping) {
        self.region = Some(region);
        self.userspace_mapping = Some(mapping);
    }

    pub fn userspace_mapping(&self) -> Option<UserspaceMapping> {
