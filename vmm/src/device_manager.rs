...
#[cfg(feature = "iommufd")]
use iommufd_bindings::iommu_hwpt_data_type;
#[cfg(feature = "smmuv3")]
use iommufd_bindings::{
    iommu_hw_info_arm_smmuv3, iommu_hwpt_data_type_IOMMU_HWPT_DATA_ARM_SMMUV3,
...
#[cfg(feature = "smmuv3")]
use iommufd_ioctls::{
    IommufdError, IommufdHwInfoData, IommufdHwptData, IommufdInvalidateData, IommufdVDevice,
    IommufdVIommu,
};
use libc::{
        ...
        let vfio_container = if device_cfg.iommu {
            ...
            //   One VfioIommuFD can be shared among multiple vSMMUv3 and VFIO devices
            {
                let _vfio_container = if let Some(vfio_container) = &self.vfio_container {
                    ...
                    self.create_vfio_container(Some(
